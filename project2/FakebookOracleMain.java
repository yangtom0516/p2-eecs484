...
public final class FakebookOracleMain {
    // Member Variables
    private static String username = "yangtom"; // replace with your uniqname
    private static String password = "Wangliao0516"; // replace with your Oracle password (default: eecsclass)
